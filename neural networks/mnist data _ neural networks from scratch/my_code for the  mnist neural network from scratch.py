...
# why this line: pixels_train = pixels_train / 255
print(train.shape)
...
def init_params():
    w1 = np.random.rand(10, 784) - 0.5  # why not randn(10,784) why should the values be between -0.5 and 0.5
...
def guess_number(index , w1, b1, w2, b2):
    ...
    show_image = image.reshape((28,28)) * 255
...
guess_number(4 , w1, b1, w2, b2)
guess_number(7 , w1, b1, w2, b2)
guess_number(8 , w1, b1, w2, b2)
